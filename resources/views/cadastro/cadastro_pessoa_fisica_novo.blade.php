                        ...
                        <div class="form-group">
                            <div align="left">
                                ...
                                <div id="div_data_nascim" class="form-group{{ $errors->has('data_nascim') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="data_nascim" type="date" class="form-control" maxlength="8" name="data_nascim" oninput="valida_data()" onkeyup="valida_data()" required>
                                ...
                                <div class="form-group{{ $errors->has('telefone') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="telefone" type="text" maxlength="11" class="form-control" name="telefone" pattern="^\d{10,11}$" required>
                                ...
                                <div class="form-group{{ $errors->has('telefone_sec') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="telefone_sec" type="text" maxlength="11" class="form-control" pattern="^\d{10,11}$" name="telefone_sec">
                                ...
                                <div class="form-group{{ $errors->has('cep') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="cep" maxlength="9" type="text" class="form-control" name="cep" oninput="formatar('#####-###', this, 'cep')" autocomplete="false" placeholder="Digite o CEP" pattern="[0-9]{5}-[0-9]{3}$">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="bairro" type="text" class="form-control" name="bairro" placeholder="Ex: Batel" required>
                                    </div>
                                </div>
