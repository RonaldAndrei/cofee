                                ...
                                @if($receitas)
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right; padding-right: 1.6em;">{{number_format($receita->valor, 2, ',', '.')}}</td>
                                            <td style="text-align: right; padding-right: 1.6em;">{{$receita->qtd_parcelas}}</td>          
                                            @if($receita->status == '0')
                                            <td>Pendente</td>
                                            @else 
                                            <td>Pago</td>
