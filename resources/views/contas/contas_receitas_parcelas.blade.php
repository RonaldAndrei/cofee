                                ...
                                @if($receitas)
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right; padding-right: 1.6em;">{{number_format($receita->valor_parcela, 2, ',', '.')}}</td>
                                            <td style="text-align: right; padding-right: 1.6em;">{{number_format($receita->valor, 2, ',', '.')}}</td>
                                            <td style="text-align: right; padding-right: 1.6em;">{{$receita->num_parcela."/".$receita->qtd_parcelas}}</td>
